...
### added
- **ตารางครีเอทีฟกลาง** ใช้ทั้งแผงแคมเปญและหน้าคลัง Creative — ชี้ค้าง = การ์ดตัวอย่าง · คลิก = ดูเต็ม (ภาพทั้งชุด ข้อความเต็ม ตัวเลข ลิงก์ ตัวอย่างจาก Meta) · หน้าคลังสลับตาราง/การ์ดได้ (653efa1)
- **สถานะเปิด/ปิดของโฆษณาและแคมเปญ** จาก `effective_status` ของ Meta (แยกจากคำแนะนำ "ควรหยุด") · migration 0014 เพิ่มคอลัมน์ `ad_creatives.effective_status` (รันบน production แล้ว 25 ก.ย.)

### changed — รีวิว UX ภาพรวมโฆษณา (25 ก.ย.)
- งบใช้ช้ากว่า 85% ของที่ควรใช้ = "ใช้ช้ากว่าแผน" (เดิม "ตามแผน") · ตารางตัดสินใจฝั่งงบ 3 ช่อง → คอลัมน์ "ควรทำ" ไม่ซ้ำทั้งตาราง (ยอดช้า + งบตามแผน = "ตรวจแอดและการปิดขาย")
- ป้าย "% ของเป้าเดือน" / "จังหวะ" / "ของที่ควรได้ถึงวันนี้" · ปี พ.ศ. ทุกที่ · ชื่อขั้น funnel "ได้ออเดอร์ / ยืนยันออเดอร์" ทุกหน้า · หัวหน้า "ภาพรวมโฆษณา" "คลัง Creative"
- มือถือ: แถบแบรนด์แถวเดียว ตารางแบรนด์เป็นการ์ด · กราฟ: legend เป็นเส้น ป้ายวันที่ไม่ชน คำอธิบายพับ · ตัวกรองรองหน้า Creative พับไว้
- ชื่อตัวนับกับตัวกรองหน้าแคมเปญชุดเดียวกัน · ปุ่มมุมบน 32px

### fixed
- **หน้าบิลโหลดไม่สำเร็จแต่ขึ้น ฿0.00** → แสดง — พร้อมแจ้งเตือนและปุ่มลองใหม่
- จอ 1024 มีเส้นแบ่งตั้งลอย · หัวข้อไทยยืดช่องไฟ · ROAS/%Ads ที่ไม่มีเป้าขึ้น "ทำได้ — ยังตัดสินใจไม่ได้" · โหมดเดโมหน้า Sync ขึ้นแดงทั้งหน้า
