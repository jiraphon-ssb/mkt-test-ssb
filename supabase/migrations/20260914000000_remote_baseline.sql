-- Remote baseline for Supabase project lzvftqhffqefqupwulus.
-- Captured from the deployed mkt_* schema on 2026-09-14.
-- This migration intentionally omits the destructive drop section from schema_nologin.sql.
-- It is marked applied on the existing remote database and is used to recreate fresh environments.
