...
export const SYNC_PUBLIC_CODES = new Set([
  ...
  "META_PAGING_INVALID", "META_TOO_MANY_PAGES", "META_RESPONSE_INVALID", "SYNC_WRITE_FAILED", "RECONCILE_FAILED", "CREATIVE_SYNC_FAILED", "AD_IDS_INVALID", "META_TOO_MUCH_DATA",
]);
