...
| ยอดขาย | วันละครั้งหลัง 9 โมง (เวลาไทย) เรียก `sales-sync` ย้อน 14 วัน + สำรวจแหล่งของระบบขาย · ลองได้ไม่เกิน 4 ครั้งต่อวันเมื่อไม่สำเร็จ |
| Creative | วันละครั้งต่อบัญชี (บัญชีที่รีเฟรชนานสุดก่อน ครั้งละ 1 บัญชีต่อรอบ) → `ads-creatives` |
