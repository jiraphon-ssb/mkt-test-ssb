...
ดึงยอดแบบแบ่งช่วง (v0.6.0): ปุ่มดึงข้อมูลหาช่วงวันที่ขาดจากประวัติ run แล้วดึงทีละ ≤10 วัน ตั้ง "ย้อนหลัง" 90–180 วันได้ · ต่อด้วยดึง Creative (`ads-creatives`) · ยังไม่มี cron (กดดึงเอง)
