...
|---|---|---|---|
| ค่าแอด · คนทักจากแอด · ยอดที่ Meta เห็น | Meta Marketing API (OAuth อ่านอย่างเดียว) | pg_cron วันละครั้งตี 5 (เวลาไทย · รอบเก็บตกถึง 05:50) | `ad_daily_facts` |
| รูป/ข้อความโฆษณา | Meta (creative + โพสต์เพจ) | วันละครั้งต่อบัญชี | `ad_creatives` |
| ยอดขาย · funnel · เงินเข้า · เป้า | ระบบขายของพี่ทัช (`sale_dashboard_facts` · `sale_goal`) | วันละครั้งตี 5 ย้อนต้นเดือน (อย่างน้อย 14 วัน) | `business_daily_facts` · `ad_sales_goals` |
