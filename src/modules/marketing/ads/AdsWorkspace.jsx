...
import { SalesRevenuePanel } from "./SalesRevenuePanel.jsx";
  ...
  return <main className="aw">
    ...
    <div className="aw-layout">
      ...
      {b ? <div className="aw-content">
        ...
        <SalesRevenuePanel brands={v.brands} sales={ads.sales} salesGoals={ads.salesGoals} range={v.range} rangeLabel={v.rangeLabel} />
        <section className="aw-panel aw-journey"><div className="aw-section-label">จากความสนใจ สู่ยอดขาย <span>ช่วงที่เลือก</span></div><SalePipeline row items={(pipeline?.items??[]).slice(0,4)} worstKey={pipeline?.worstKey} goals={goals}/>{pipeline?.estimated&&<p className="aw-key">Meta บอกได้แค่ “คนทัก” — Lead มัดจำ และออเดอร์จะขึ้นเมื่อเชื่อมระบบขายแล้ว (ตอนนี้ขึ้น “—” แทนการประมาณ)</p>}</section>
