...
export function AdsWorkspace({ v, controls, ChannelCard, SalePipeline, settings, updateAdsControl, toast }) {
  ...
  return <main className="aw">
    <section className="aw-toolbar" aria-label="ตัวกรองรายงาน"><header className="aw-header"><h1>Overview ads</h1><div className="aw-header-actions"><a className="aw-settings-link" href="/mkt/ads/sync">สถานะ Sync</a><a className="aw-settings-link" href="/mkt/ads?panel=settings"><Settings2 size={15}/> ตั้งค่า</a></div></header><div className="aw-controls">{controls}<span className="aw-demo"><i/> Mock data</span></div></section>
