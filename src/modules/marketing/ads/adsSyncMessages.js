...
const TEXT = {
  ...
  // ── เป้าเดือนของ JUNTAKARN (เฟส jkGoals) ──
  JK_GOAL_MISSING: "ระบบ TMK ยังไม่มีฟังก์ชัน jk_ads_monthly_goal — ต้องรันไฟล์ SQL เป้าในโปรเจกต์ TMK ก่อน",
  JK_GOAL_NO_PERMISSION: "คีย์ที่ตั้งไว้เรียกฟังก์ชันเป้าของระบบ TMK ไม่ได้ (ต้องเป็น service role key ของโปรเจกต์ TMK)",
  JK_GOAL_BAD_KEY: "JK_API_KEY ผิดหรือหมดอายุ — ดึงเป้า JUNTAKARN ไม่ได้",
  JK_GOAL_ERROR: "เรียกเป้าจากระบบ TMK ไม่สำเร็จ — ตรวจ JK_API_URL",
  JK_GOAL_OPEN: "ระบบ TMK ตอบกลับผิดรูปในส่วนเป้า ยังไม่ได้บันทึกเป้า",
  ...
  JK_GOAL_FAILED: "ดึงเป้า JUNTAKARN ไม่สำเร็จ ยอดขายและเป้าของแบรนด์อื่นไม่กระทบ",
