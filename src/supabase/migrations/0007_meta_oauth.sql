...
create table if not exists ad_provider_authorizations (
...
create table if not exists ad_authorized_accounts (
...
create index if not exists ad_authorizations_user_idx on ad_provider_authorizations(user_id,provider,status);
