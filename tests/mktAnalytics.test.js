...
describe("heatmap เวลาโพสต์", () => {
  const r = { start: "2026-07-01T00:00:00.000Z", end: "2026-08-01T00:00:00.000Z" };
  /* ต้องอ่านเป็นเวลาไทยเสมอ ไม่ใช่เวลาของเครื่องที่รัน — เดิมใช้ getDay()/getHours()
     ทำให้ผลเพี้ยนเมื่อรันบนเซิร์ฟเวอร์ UTC (เจอครั้งแรกตอน CI รันรอบแรก 16 ก.ย. 2569) */
